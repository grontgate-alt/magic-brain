...
async def main():
    ...
    print("🔹 Тест 3: Qdrant")
    try:
        qdrant.create_collection(collection_name="test_ping", vectors_config={"size": 4, "distance": "Cosine"})
        qdrant.upsert(collection_name="test_ping", points=[{"id": 1, "vector": [0.1]*4, "payload": {"text":"ping"}}])
