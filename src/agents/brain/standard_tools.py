...
__skills__ = [
    {
        "name": "read_file",
        "desc": "📖 Чтение содержимого файла. Возвращает текст.",
        "params": {"path": {"type": "string", "desc": "Полный путь"}},
        "func": read_file,
    },
    {
        "name": "write_file",
        ...
        "params": {
            "path": {"type": "string", "desc": "Путь"},
            "content": {"type": "string", "desc": "Текст"},
        },
        "func": write_file,
    },
    {
        "name": "execute_bash",
        "desc": "💻 Выполнение bash-команды в системе.",
